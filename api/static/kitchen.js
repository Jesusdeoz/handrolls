...
async function render() {
  try {
    ...
    document.getElementById('col_nuevo').innerHTML = nuevo.map(cardSoloLectura).join('');
    document.getElementById('col_prep').innerHTML  = prep.map(cardSoloLectura).join('');
    document.getElementById('col_listo').innerHTML = listo.map(cardSoloLectura).join('');
    document.getElementById('col_desp').innerHTML  = desp.map(cardSoloLectura).join('');
  } catch (e) {
